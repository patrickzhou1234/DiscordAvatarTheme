...
let injectHTML = '<svg width="108" height="96" viewBox="0 0 108 96" class="avatarDecoration-2Wb1Au" aria-hidden="true"><foreignObject x="0" y="0" width="96" height="96" mask="url(#svg-mask-avatar-decoration-status-round-80)"><div class="avatarStack-3Bjmsl"><img class="avatar-31d8He" src="https://cdn.discordapp.com/avatar-decoration-presets/a_d650e22f6c4bab4fc0969e9d35edbcb0.png?size=128&passthrough=true" alt=" " aria-hidden="true"></div></foreignObject></svg>';
let profInject = '<svg width="162" height="144" viewBox="0 0 162 144" class="avatarDecoration-2Wb1Au" aria-hidden="true"><foreignObject x="0" y="0" width="144" height="144" mask="url(#svg-mask-avatar-decoration-status-round-120)"><div class="avatarStack-3Bjmsl"><img class="avatar-31d8He" src="https://cdn.discordapp.com/avatar-decoration-presets/a_d650e22f6c4bab4fc0969e9d35edbcb0.png?size=240&passthrough=true" alt=" " aria-hidden="true"></div></foreignObject></svg>';
setInterval(() => {
